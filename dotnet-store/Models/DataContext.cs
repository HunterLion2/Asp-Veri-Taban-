...
public class DataContext : DbContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Urun>().HasData(
            new List<Urun> {
                new Urun() { Id = 1, UrunAdi= "Apple Watch 7", Fiyat= 10000, Aktif= true },
                new Urun() { Id = 2, UrunAdi= "Apple Watch 8", Fiyat= 20000, Aktif= false },
                new Urun() { Id = 3, UrunAdi= "Apple Watch 9", Fiyat= 30000, Aktif= true },
                new Urun() { Id = 4, UrunAdi= "Apple Watch 10", Fiyat= 40000, Aktif= true },
                new Urun() { Id = 5, UrunAdi= "Apple Watch 11", Fiyat= 50000, Aktif= false },
